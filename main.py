...
def boten(message):
    ...
    M = types.InlineKeyboardButton('develop', url='https://t.me/Punda_Hustle')
...
def masg(call):
	...
	if call.data =="Penteste":
		...
		M = types.InlineKeyboardButton('المطور', url='https://t.me/Punda_Hustle')
...
if __name__ == "__main__":
    bot.remove_webhook()
    bot.set_webhook(url="https://idcheckerup.herokuapp.com"+str(BOT_TOKEN))
